...
import { getOrderListByCriteria , getAutoDispatch , submitDispatch , getAllSubstation} from "@/api/dispatch/autoDispatch"

// 导入需要的数据类型，需要用{}括起来（哪怕只引入一种数据）
import { AutoQuery , OrderPageVO , SubstationInfo , StationQuery , SubmitRequest } from "@/api/dispatch/autoDispatch/types"
